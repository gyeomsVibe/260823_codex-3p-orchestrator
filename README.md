...
[![Tests](https://img.shields.io/badge/Unit_Tests-237_Passed-10b981?style=flat-square&logo=python)](tests/)
...
| **도구 수명주기** | 데몬 상주형 무한 대기 (비용/좀비 위험) | **필요 시 호출 후 종료되는 단발성(Ephemeral) CLI** | 단위 테스트 237건 통과 |
...
# 4. 전체 단위 테스트 일괄 검증 (237건 통과, 1건 건너뜀)
...
│
├── tests/                                             # [검증] 단위 및 통합 테스트 (237건 통과, 1건 건너뜀)
